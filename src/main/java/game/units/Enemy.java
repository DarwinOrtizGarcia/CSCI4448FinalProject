...
public class Enemy extends Character {
    ...
    public Enemy(String name, Double initialHealth, Double initialStrength, Double initialMagic, Double initialDefense, Double initialResistance, int initialRange, int initialMovement, int[] position, AttackStrategy strategy)
    {
