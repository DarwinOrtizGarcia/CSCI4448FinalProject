...
public class AlliedUnitFactory {
    ...
    public Allied createToughAlly(String name) {return new Allied(name, 15, 3, 2, 4, 1, 3, new int[]{0, 0}, new Weapon("Iron Sword"));}
    public Allied createArcherAlly(String name) {return new Allied(name, 12, 2, 2, 2, 3, 5, new int[]{0, 0}, new Weapon ("Iron Bow"));}
    public Allied createFighterAlly(String name) {return new Allied(name, 15, 3, 2, 3, 2, 4, new int[]{0, 0}, new Weapon("Iron Sword"));}
